...
class OrderShowControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->route = fn(int $id) => route('order.show', ['id' => $id]);
    ...
    {
        $response = $this->json(self::METHOD_GET, ($this->route)($this->order->getKey()));
    ...
    public function testErrorExecution(): void
    {
        ...
        $id = 0;
        $response = $this->json(self::METHOD_GET, ($this->route)($id));
