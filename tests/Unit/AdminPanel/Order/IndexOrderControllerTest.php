...
class IndexOrderControllerTest extends TestCase
{
    ...
    public function testFailedIndexOrderUseCaseCall(): void
    {
        $this->indexOrderRequestMock
            ->shouldReceive('validated')
            ->once()
     ...
     * @dataProvider getDataProvider
     */
    public function testFailedIndexOrderPresenterCall(IndexOrderResponseDTO $indexOrderResponseDTO): void
    {
        $this->indexOrderRequestMock
            ->shouldReceive('validated')
            ->once()
